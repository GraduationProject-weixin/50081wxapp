...
# 50081wxapp移动平台的远程在线诊疗系统

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1BPtKekEv3?p=84)
...
因此，开发合适的微信小程序基于移动平台的远程在线诊疗系统，可以方便管理人员对微信小程序基于移动平台的远程在线诊疗系统的管理，提高信息管理工作效率及查询效率，用户可以在手机上通过微信小程序来订餐，更加的方便，有利于更好的为人们服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。微信小程序基于移动平台的远程在线诊疗系统的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。
...
# 3系统分析
## 3.1可行性分析
通过对本微信小程序基于移动平台的远程在线诊疗系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本微信小程序基于移动平台的远程在线诊疗系统后端采用SSM框架进行开发，是一种成熟的框架，开发有很多教程的，微信开发也有很多教程，并且网络上很多免费的教程。  

因此，微信小程序基于移动平台的远程在线诊疗系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本微信小程序基于移动平台的远程在线诊疗系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本微信小程序基于移动平台的远程在线诊疗系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此微信小程序基于移动平台的远程在线诊疗系统要严格控制管理权限，具体要求如下：

（1）要想对微信小程序基于移动平台的远程在线诊疗系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
概念模式的设计方法是在需求分析的基础上，用概念数据模型（例如E-R模型）表示数据及数据之间的相互联系，设计出反映科室信息需求和处理需求的数据库系统概念模式。概念设计的目标是准确描述应用领域的信息模式，支持用户的各种应用，这样既容易转换为数据库系统逻辑模式，又容易为用户理解。数据库系统概念模式是面向现实世界的数据模型，不能直接用于数据库系统的实现。在此阶段，用户可以参与和评价数据库系统的设计，从而有利于保证数据库系统的设计与用户的需求相吻合。在概念模式的设计中，E-R模型法是最常见的设计方法。本系统的E-R图如下图所示：
...
图4.14 科室类型信息实体属性图
### 4.3.2数据库设计表
微信小程序基于移动平台的远程在线诊疗系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|jiuzhenkahao|varchar(200)|是|NULL|就诊卡号|
|xingming|varchar(200)|是|NULL|姓名|
|keshimingcheng|varchar(200)|是|NULL|科室名称|
|bingqingjiexi|longtext|是|NULL|病情解析|
|zhuyishixiang|longtext|是|NULL|注意事项|
|zhiliaozhouqi|varchar(200)|是|NULL|治疗周期|
|chufangdan|longtext|是|NULL|处方单|
...
|bingzhengmiaoshu|longtext|是|NULL|病症描述|
|zhiliaoqingkuang|longtext|是|NULL|治疗情况|
|jiuzhenjilu|longtext|是|NULL|就诊记录|
|riqi|date|是|NULL|日期|
...
|yishengjieshao|longtext|是|NULL|医生介绍|
|guahaofeiyong|int(11)|是|NULL|挂号费用|
|lianxidianhua|varchar(200)|是|NULL|联系电话|
|paibanbiao|longtext|是|NULL|排班表|
|tupian|varchar(200)|是|NULL|图片|
|userid|bigint(20)|是|NULL|用户id|
表4.5 留言板
...
|quxiaoshijian|date|是|NULL|取消时间|
|tupian|varchar(200)|是|NULL|图片|
|jiuzhenkahao|varchar(200)|是|NULL|就诊卡号|
|xingming|varchar(200)|是|NULL|姓名|
...
|wenzhendafu|longtext|是|NULL|问诊答复|
|dafushijian|date|是|NULL|答复时间|
|tupian|varchar(200)|是|NULL|图片|
|gonghao|varchar(200)|是|NULL|工号|
|yishengxingming|varchar(200)|是|NULL|医生姓名|
|userid|bigint(20)|是|NULL|用户id|
...
|lianxidianhua|varchar(200)|是|NULL|联系电话|
|shebeijieshao|longtext|是|NULL|设备介绍|
|zhuceriqi|date|是|NULL|注册日期|
|tupian|varchar(200)|是|NULL|图片|
表4. 13用户
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|jiuzhenkahao|varchar(200)|否||就诊卡号|
...
|yishengxingming|varchar(200)|是|NULL|医生姓名|
|wenzhenneirong|longtext|是|NULL|问诊内容|
|wenzhenshijian|date|是|NULL|问诊时间|
|jiuzhenkahao|varchar(200)|是|NULL|就诊卡号|
|xingming|varchar(200)|是|NULL|姓名|
|tupian|varchar(200)|是|NULL|图片|
|userid|bigint(20)|是|NULL|用户id|
...
|yishengxingming|varchar(200)|是|NULL|医生姓名|
|guahaofeiyong|int(11)|是|NULL|挂号费用|
|guahaoshijian|date|是|NULL|挂号时间|
